    ...
    <section class="success" id="about">
        <div class="container">
            ...
            <div class="row">
                ...
                <h3>Current</h3>
                    <?php
                        echo "<p>Current Temperature:".$contact['getWeather'][0][1]."C<br />";
                        echo "Min. Temperature:".$contact['getWeather'][0][2]."C<br />";
                        echo "Max. Temperature:".$contact['getWeather'][0][3]."C<br />";
                        echo "Humidity:".$contact['getWeather'][0][4]."%<br />";
                        echo "Weather:".$contact['getWeather'][0][0]."<br />";
                        echo "Updated At:".$contact['getWeather'][0][5]."<br /></p>";
                    ?>
                </div>
                <div class="col-lg-4">
                    <h3> Forecast</h3>
                    <?php
                      $counter=0;
                      foreach($contact['getWeather'][1] as $key=>$value)
                       { 
                        if($counter==0)
                        {
                            $counter++;
                        ...
                        echo "<p>Current Temperature:".$value[0]."C<br />";
                        echo "Min. Temperature:".$value[1]."C<br />";
                        echo "Max. Temperature:".$value[2]."C<br />";
                        echo "Humidity:".$value[3]."%<br />";
                        echo "Rain:".$value[4]."<br />";
